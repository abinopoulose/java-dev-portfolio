				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								href="/Abino-Poulose-Resume-Java-Dev.pdf"
								target="_blank"
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								<motion.a
									target='_blank'
									href="https://github.com/abinopoulose"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@abinopoulose</p>
									</div>
								</motion.a>
								<motion.a
									target='_blank'
									href="https://www.linkedin.com/in/abinopoulose/"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">Abino Poulose</p>
									</div>
								</motion.a>
								{/* <motion.a
									href="#"
