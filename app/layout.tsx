...
export const metadata: Metadata = {
	title: 'Abino Poulose - Full Stack Developer',
	description:
	...
	authors: [{ name: 'Abino Poulose' }],
	creator: 'Abino Poulose',
	openGraph: {
		title: 'Abino Poulose - Full Stack Developer Portfolio',
		...
		siteName: 'Abino Poulose - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Abino Poulose - Full Stack Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
